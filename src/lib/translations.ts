...
export const translations = {
  en: {
    ...
    closePostBtn: 'Close Request',
    closePostModalTitle: 'Close Trip Request',
    closePostConfirmText: 'Are you sure you want to close this trip request? Tourist guides will no longer be able to submit new bids. All existing bids and conversation history will remain saved.',
    confirmCloseBtn: 'Yes, Close Post',
    keepOpenBtn: 'Keep Open',
    reopenPostBtn: 'Reopen Request',
    postClosedBadge: 'Closed',
  ...
  vi: {
    ...
    closePostBtn: 'Đóng Yêu Cầu',
    closePostModalTitle: 'Đóng Bài Đăng Yêu Cầu Tour',
    closePostConfirmText: 'Bạn có chắc chắn muốn đóng yêu cầu tour này? Các hướng dẫn viên sẽ không thể gửi thêm báo giá mới. Toàn bộ báo giá và lịch sử thương lượng hiện tại vẫn được bảo lưu an toàn.',
    confirmCloseBtn: 'Đồng Ý Đóng Yêu Cầu',
    keepOpenBtn: 'Giữ Mở Yêu Cầu',
    reopenPostBtn: 'Mở Lại Yêu Cầu',
    postClosedBadge: 'Đã Đóng',
